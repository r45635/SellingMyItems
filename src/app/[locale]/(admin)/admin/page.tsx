    ...
    <div className="space-y-8">
      ...
      <section className="space-y-3">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <StatCard label="Total accounts" value={totalProfiles[0].value} />
          <StatCard label="Buyers" value={purchaserCount[0].value} />
          <StatCard label="Sellers" value={sellerCount[0].value} />
          <StatCard
      ...
      <section className="space-y-3">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <StatCard label="Total projects" value={totalProjects[0].value} />
          <StatCard label="Public" value={publicProjects[0].value} />
          <StatCard
            label="Draft"
            value={
          ...
          />
          <StatCard label="Deleted" value={deletedProjects[0].value} />
        </div>
      </section>
      ...
      <section className="space-y-3">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
          <StatCard label="Total items" value={totalItems[0].value} />
          <StatCard
            label="Available"
            value={statusMap.get("available") ?? 0}
          />
          <StatCard label="Reserved" value={statusMap.get("reserved") ?? 0} />
          <StatCard label="Sold" value={statusMap.get("sold") ?? 0} />
          <StatCard label="Hidden" value={statusMap.get("hidden") ?? 0} />
        </div>
      </section>
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold flex items-center gap-2">
          <Store className="h-5 w-5" /> Catalog value
        </h2>
      ...
      <section className="space-y-3">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <StatCard label="Purchase intents" value={totalIntents[0].value} />
